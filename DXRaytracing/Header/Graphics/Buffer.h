...
enum class BufferUsage : uint32_t
{
	...
	BUFFER_USAGE_RAYTRACING_ACCELERATION_STRUCTURE = (1 << 4),
	BUFFER_USAGE_CONSTANT = (1 << 5),
	BUFFER_USAGE_UPLOAD = (1 << 6)
};
...
{
	BufferDesc() = default;
	BufferDesc(BufferUsage usage, std::size_t numElements, std::size_t elementSize, std::size_t alignment = 0)
		: Usage(usage), NumElements(numElements), ElementSize(elementSize), Alignment(alignment) {}
